...
parser.add_argument('--load_path_od', type=str, default='experiments/best_od_UW_16Mar', help='path to saved model - od')
parser.add_argument('--load_path_mac', type=str, default='experiments/best_mac_UW_16Mar', help='path to saved model - mac')
...
parser.add_argument('--csv_out', type=str, default='results/submission_UW_galdran_16Mar.csv', help='path to output csv')
